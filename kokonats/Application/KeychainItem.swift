...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.biiiiit.club-kokonats", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            ...
            Logger.debug("Unable to delete userIdentifier from keychain")
        }
    }
}
